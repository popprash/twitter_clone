...
const ProfilePage = () => {
  ...
  return (
    <div className='flex-1 border-gray-700 min-h-screen px-0 sm:px-4'>
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='flex flex-col'>
          {!isLoading && !isRefetching && user && (
            <>
              <div className='flex flex-wrap gap-4 px-3 sm:px-4 py-2 items-center'>
              ...
              <div className='flex flex-col gap-3 px-4 mt-24 sm:flex-row sm:items-center sm:justify-end'>
